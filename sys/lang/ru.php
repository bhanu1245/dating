<?php
    ...
    $TEXT['page-profile-deactivation-sub-title'] = "Покидаете нас?<br>Если вы продолжите, то все ваши персональные данные, а также созданный вами контент (например: личные сообщения, уведомления, публикации, комментарии и т. д.) будут безвозвратно удалены! Вы не сможете восстановить свою учетную запись и данные! В будущем, если вы захотите вернуться, вам придется создать новую учетную запись!";
    $TEXT['msg-error-deactivation'] = "Что-то пошло не так. Пожалуйста, повторите попытку позже..";

    $TEXT['label-login-create-promo'] = "Ваша учетная запись создана при авторизации по протоколу OAuth. Вашему аккаунту предоставлен автоматически сгенерированный логин. Вы можете изменить логин своей учетной записи и создать пароль для персонализации своего профиля, а также позволит авторизоваться с помощью пароля и логина!";
    $TEXT['label-login-create-promo-2'] = "Чтобы иметь возможность управлять своими подключениями, вам необходимо создать имя пользователя и пароль для своей учетной записи! Это сделает вашу учетную запись независимой от протокола Oauth и позволит вам войти в систему, используя свое имя пользователя и пароль!";
    $TEXT['label-login-create'] = "Создать логин и пароль";
    $TEXT['label-login-create-sub-title'] = "Введите желаемое имя для вашего логина, а затем придумайте пароль (только латинские буквы и цифры, должны начинаться с буквы). Отнеситесь к этому серьезно: 1) изменить логин в дальнейшем будет невозможно, 2) вы сможете использовать эти данные для входа в свой аккаунт!";
    $TEXT['label-login-current'] = "Текущий логин";
    $TEXT['label-login-new'] = "Новый логин";

    $TEXT['label-login-create-error'] = "Логин неправильный формат или уже занят";
    $TEXT['label-login-create-success'] = "Вы успешно создали имя пользователя и пароль!";
    $TEXT['label-password-old-error'] = "Старый пароль имеет неверный формат или неверен";
    ...
    $TEXT['label-payments-credits-paypal'] = "Покупка кредитов через PayPal";
    $TEXT['action-buy-credits-stripe'] = "Buy credits via Stripe";
    $TEXT['action-buy-credits-paypal'] = "Buy credits via PayPal";

    // For version 7.3

    $TEXT['action-signin-phone'] = "Авторизация по СМС";
    $TEXT['action-signin-google'] = "Авторизация через Google";

    $TEXT['label-signup-complete'] = "Complete your registration";
    $TEXT['label-signup-title'] = "To complete registration, you need to upload a profile photo.";
    $TEXT['label-signup-title-1'] = "Profile photo cannot contain violence, racy or pornographic content.";
    $TEXT['label-signup-title-2'] = "The photo must be in jpg or png format.";

    $TEXT['label_signup_addon_title'] = "Also, please select your age, gender and orientation.";

    $TEXT['label-signup-image-error-adult'] = "Adult image detected. Please select another photo.";
    $TEXT['label-signup-image-error-violence'] = "Violence image detected. Please select another photo.";
    $TEXT['label-signup-image-error-racy'] = "Racy image detected. Please select another photo.";
    $TEXT['label-signup-image-error-face'] = "No faces found in the image. Please select another photo.";
    $TEXT['label-signup-image-error-format'] = "Error file format. Please select another photo.";
    $TEXT['label-signup-image-error-size'] = "The file size is too large. Please select another photo.";
    $TEXT['label-signup-image-error-wh'] = "The height and/or width of the file is too small. Please select another photo.";
    $TEXT['label-signup-image-error-unknown'] = "Unknown error. Please select another photo.";
    $TEXT['label-signup-image-error-success'] = "Thank you, your profile photo has been successfully set!";

    $TEXT['label-signup-image-action-finish'] = "Finish";
    $TEXT['label-signup-image-action-upload'] = "Upload photo";