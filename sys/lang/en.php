...
//    $TEXT['action-join'] = "Регистрация";
    ...
    $TEXT['label-payments-credits-paypal'] = "Buying credits with PayPal";
    ...
    $TEXT['action-signin-phone'] = "Continue with Phone";
    $TEXT['action-signin-google'] = "Continue with Google";
