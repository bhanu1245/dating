...
class auth extends db_connect
{
    ...
    static function setSession($user_id, $user_login, $user_fullname, $user_photo_url, $user_verified, $user_balance, $user_pro_mode, $user_free_messages_count, $access_level, $access_token)
    {
    ...
    static function getRegistrationComplete(): Int
    {
        if (isset($_SESSION['registration_complete'])) {

            return $_SESSION['registration_complete'];
    ...
    static function setRegistrationComplete($photo_upload): void
    {
        $_SESSION['registration_complete'] = $photo_upload;
    }
    ...
    static function setCurrentUserLogin($user_login)
    {
        $_SESSION['user_login'] = $user_login;
    }
