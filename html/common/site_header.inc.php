...
<head>
    ...
    <link rel="stylesheet" href="/css/main.css?x=4" type="text/css" media="screen,projection"/>
    <link rel="stylesheet" href="/css/my.css?x=1" type="text/css" media="screen,projection"/>
    <link rel="stylesheet" href="/css/photo.css" type="text/css" media="screen,projection"/>
    ...
    <?php
        ...
        <link rel="stylesheet" href="/css/<?php echo $css."?x=12"; ?>" type="text/css" media="screen">
    <?php
        endforeach;
    ?>
    ...
    <?php
        ...
        if (isset($page_id) && $page_id === "signup" || isset($page_id) && $page_id === "update" || isset($page_id) && $page_id === "main" || isset($page_id) && $page_id === "support" || isset($page_id) && $page_id === "remind" || isset($page_id) && $page_id === "otp" || isset($page_id) && $page_id === "settings_deactivation" || isset($page_id) && $page_id === "phone") {
        ...
        if (isset($page_id) && $page_id === "otp" || isset($page_id) && $page_id === "phone") {
