        ...
        <nav class="sidebar-nav"> <!-- Sidebar navigation-->
            ...
            <ul id="sidebarnav">
                ...
                <li class="nav-small-cap">General</li>
                    ...
                    <li class="">
                        <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "analytics") { echo "active";} ?>" href="/admin/analytics" aria-expanded="false">
                ...
                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "payments") { echo "active";} ?>" href="/admin/payments" aria-expanded="false">
                        <i class="ti-credit-card"></i>
                        <span class="hide-menu">Payments Settings</span>
                    </a>
                </li>

                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "ufake") { echo "active";} ?>" href="/admin/ufake" aria-expanded="false">
                        <i class="ti-spray"></i>
                        <span class="hide-menu">Fake Users</span>
                    </a>
                </li>
                ...
                <li class="nav-small-cap">Editor</li>

                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "terms") { echo "active";} ?>" href="/admin/editor?id=terms" aria-expanded="false">
                        <i class="ti-pencil-alt"></i>
                        <span class="hide-menu">Edit Terms of use</span>
                    </a>
                </li>

                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "about") { echo "active";} ?>" href="/admin/editor?id=about" aria-expanded="false">
                        <i class="ti-pencil-alt"></i>
                        <span class="hide-menu">Edit About</span>
                    </a>
                </li>

                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "gdpr") { echo "active";} ?>" href="/admin/editor?id=gdpr" aria-expanded="false">
                        <i class="ti-pencil-alt"></i>
                        <span class="hide-menu">Edit GDPR</span>
                    </a>
                </li>

                <li>
                    <a class="waves-effect waves-dark <?php if (isset($page_id) && $page_id === "privacy") { echo "active";} ?>" href="/admin/editor?id=privacy" aria-expanded="false">
                        <i class="ti-pencil-alt"></i>
                        <span class="hide-menu">Edit Privacy</span>
                    </a>
                </li>
